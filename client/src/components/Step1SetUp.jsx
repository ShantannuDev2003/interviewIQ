        ...
        <motion.div
            ...
            <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
                <motion.div
                    ...
                    <h2 className='text-4xl font-boold text-gray-800 mb-6'>
                    ...
                    <div className='space-y-6'>
                        ...
                        {!analysisDone && (
                            ...
                            >
                                ...
                                <input type="file" accept="application/pdf" id="resumeUpload" className='hidden' onChange={(e) => setResumeFile(resumeFile ? e.target.files[0] ? e.target.files[0] : resumeFile : e.target.files[0])} />
                                ...
                                {resumeFile && (
                                    <motion.button onClick={(e) => { e.stopPropagation(); handleUploadResume(); }}
                                        whileHover={{ scale: 1.02 }}
                                        className='mt-4  bg-gray-900 text-white py-2 px-4 rounded-lg hover:bg-gray-800 transition'
                ...
                ${atsScore >= 80 ? 'text-green-600'
                                                    : atsScore >= 60 ? 'text-blue-500'
                                                        : atsScore >= 40 ? 'text-yellow-500'
                                                            : 'text-red-500'}`}>
                                                {atsScore} / 100
                                            </span>
                                        </div>
                                        ...
                                        <div className='w-full h-3 bg-gray-200 rounded-full overflow-hidden'>
                                            <motion.div
                                                ...
                                                style={{
                                                    background:
                                                        atsScore >= 80 ? 'linear-gradient(to right, #22c55e, #16a34a)'
                                                            : atsScore >= 60 ? 'linear-gradient(to right, #3b82f6, #2563eb)'
                                                                : atsScore >= 40 ? 'linear-gradient(to right, #facc15, #f59e0b)'
                ...
                ${atsScore < 40 ? 'text-red-500' : 'text-yellow-500'}`}>

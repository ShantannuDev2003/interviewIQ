...
const Step2Interview = ({ interviewData ,onFinish}) => {
  ...
  return (
    <div className='min-h-screen  bg-linear-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6'>
                <div className='w-full max-w-350p min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
...
<div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
    ...
    {!isIntroPhase && (<div className='relative mb-6  bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm gap-4'>
                ...
                <p className='text-emerald-700 font-medium mb-4'>{feedback}</p>
                 <button 
                    ...
                    className='w-full bg-gradient-to-r  from-emerald-600 to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-1'>
                          {currentIndex + 1 === 5 ? "Finish Interview" : "Next Question"} 

     ...
     <div className="flex-1 px-6 py-20">
      ...
      <div className='flex justify-center mb-6'>
       ...
       <div className='text-center mb-28'> 
          ...
          className='text-4xl md:text-6xl font-semibold leading-snug max-w-4xl mx-auto'
          >
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
           {
            [
              ...
              <motion.div key={index}
                 ...
                 whileHover={{rotate:0,scale:1.06,transition: {duration: 0.2}}}
                 style={{
        ...
        <div className='grid md:grid-cols-2 gap-10'>
                 {
                  [
                    ...
                    },
                    {
                      ...
                      desc:"Project-specifc questions based on your resume."
                    },
                    {
                      image:pdfImg,
                      icon:<BsFileEarmarkText size={20}/>,
                    ...
                    >
                     ...
                     <div className='flex  items-center justify-between gap-6'>
                                  ...
                                  <div className='w-1/2 flex justify-end'>
                                     <img 
                                     src={item.image} 
                                     alt={item.title}  className='w-28 h-28 object-contain '/>
                                  </div>

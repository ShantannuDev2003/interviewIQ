...
export const analyzeResume = async (req, res) => {
    try {
        ...
        console.log("Recievd file:", req.file);
        ...
        try {
            ...
            console.warn("Failed to delete temp file:", fileError);
        }
        ...
        const messages = [
            {
                ...
                Speak in simple,natural English as if your are directly talking to the candidate.
